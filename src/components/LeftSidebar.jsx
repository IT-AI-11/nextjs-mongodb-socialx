    ...
    return (
        <div className='flex flex-col p-3 justify-between h-screen items-center'>
          ...
          Sign in
                ...
                <div className='flex items-center justify-center bg-blue-400 text-white rounded-full  hover:brightness-95 transition-all duration-200 w-48 h-9 shadow-md hidden xl:inline font-semibold'>
                    <SignedIn className=' flex items-center justify-center '>
                        <SignOutButton />
                    </SignedIn>
                    <SignedOut className=' flex items-center justify-center '>
                        <SignInButton />
                    </SignedOut>
                </div>
